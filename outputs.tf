output "arc_kubernetes_cluster_extensions_id" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.id if v.id != null && length(v.id) > 0 }
}
output "arc_kubernetes_cluster_extensions_cluster_id" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.cluster_id if v.cluster_id != null && length(v.cluster_id) > 0 }
}
output "arc_kubernetes_cluster_extensions_configuration_protected_settings" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.configuration_protected_settings if v.configuration_protected_settings != null && length(v.configuration_protected_settings) > 0 }
}
output "arc_kubernetes_cluster_extensions_configuration_settings" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.configuration_settings if v.configuration_settings != null && length(v.configuration_settings) > 0 }
}
output "arc_kubernetes_cluster_extensions_current_version" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.current_version if v.current_version != null && length(v.current_version) > 0 }
}
output "arc_kubernetes_cluster_extensions_extension_type" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.extension_type if v.extension_type != null && length(v.extension_type) > 0 }
}
...
output "arc_kubernetes_cluster_extensions_name" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.name if v.name != null && length(v.name) > 0 }
}
output "arc_kubernetes_cluster_extensions_release_namespace" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.release_namespace if v.release_namespace != null && length(v.release_namespace) > 0 }
}
output "arc_kubernetes_cluster_extensions_release_train" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.release_train if v.release_train != null && length(v.release_train) > 0 }
}
output "arc_kubernetes_cluster_extensions_target_namespace" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.target_namespace if v.target_namespace != null && length(v.target_namespace) > 0 }
}
output "arc_kubernetes_cluster_extensions_version" {
  ...
  value       = { for k, v in azurerm_arc_kubernetes_cluster_extension.arc_kubernetes_cluster_extensions : k => v.version if v.version != null && length(v.version) > 0 }
}
